...
from demeter.gmx import GmxV2PerpMarket, GmxV2Pool
...
class GmxV2PositionStrategy(Strategy):
    ...
    def increase(self, snapshot: Snapshot):
        ...
        result = gmx_market.increase_position(
            ...
            collateral_amount=948.752617,
            is_long=True,
            size_in_usd=4446.51078972797,
        )
        pass
...
if __name__ == "__main__":
    ...
    market_key = MarketInfo("GMX_ETH", MarketTypeEnum.gmx_v2_prep)
    market = GmxV2PerpMarket(market_key, pool, data_path="../../tests/data")
    market.load_data(
        ChainType.arbitrum,
