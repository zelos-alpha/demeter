...
class ActionTypeEnum(Enum):
    ...
    * collect_fee
    ...
    general_swap = "general_swap"
    uni_lp_add_liquidity = "uni_lp_add_liquidity"
    uni_lp_remove_liquidity = "uni_lp_remove_liquidity"
    uni_lp_buy = "uni_lp_buy"
    uni_lp_sell = "uni_lp_sell"
    uni_lp_swap = "uni_lp_swap"
    uni_lp_collect = "uni_lp_collect"
    aave_supply = "aave_supply"
    aave_withdraw = "aave_withdraw"
    aave_borrow = "aave_borrow"
    aave_repay = "aave_repay"
    aave_liquidation = "aave_liquidation"
    option_buy = "option_buy"
    option_sell = "option_sell"
    option_deliver = "option_deliver"
    option_expire = "option_expire"
    deribit_deposit = "deribit_deposit"
    deribit_withdraw = "deribit_withdraw"
    squeeth_open_vault = "squeeth_open_vault"
    squeeth_update_collateral = "squeeth_update_collateral"
    squeeth_update_short = "squeeth_update_short"
    squeeth_deposit_lp = "squeeth_deposit_lp"
    squeeth_withdraw_lp = "squeeth_withdraw_lp"
    squeeth_reduce_debt = "squeeth_reduce_debt"
    squeeth_liquidation = "squeeth_liquidation"
    gmx_buy_glp = "gmx_buy_glp"
