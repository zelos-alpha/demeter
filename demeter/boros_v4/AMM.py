...
class AMM:
    ...
    def swap_by_boros_router(self, size_out: int) -> int:
    ...
    def calc_swap_size(self, target_rate: Decimal) -> int:
...
class PositiveAMM(AMM):
    ...
    def calc_swap_size(self, target_rate: Decimal) -> Decimal:
        state = self._get_state()
        return PositiveAMMMath.calc_swap_size(state, target_rate)  # todo
...
class NegativeAMM(AMM):
    ...
    def calc_swap_size(self, target_rate: Decimal) -> Decimal:
        state = self._get_state()
        return NegativeAMMMath.calc_swap_size(state, target_rate)  # todo
